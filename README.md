...
<p align="center"> API que consume los personajes de la API REST de Rick and Morty y muestra la informacion como nombre, especie e imagen en un grid y permite filtrar por nombre </p>
...
- Dentro de Spring Tools, nos dirigimos al menú "File->Open Projects for File System"
  ...
  - Finalmente, en el explorador de internet escribimos el endpoint GET http://localhost:8080/personajes/listarPersonajes
